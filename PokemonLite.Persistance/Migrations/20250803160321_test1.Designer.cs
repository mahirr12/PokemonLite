...
namespace PokemonLite.Persistance.Migrations
{
    ...
    [Migration("20250803160321_test1")]
    partial class test1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PokemonLite.Persistance.UserImplement", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PokemonLite.Persistance.UserImplement", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PokemonLite.Domain.Entities.Trainer", b =>
                {
                    b.HasOne("PokemonLite.Persistance.UserImplement", "User")
                        .WithOne("Trainer")
